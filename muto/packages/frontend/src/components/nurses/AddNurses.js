          ...
          <div class="col-md-10 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body bg-light">
                    <h4 class="card-title">Add New Nurse</h4>
                    <hr className=""/>
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="nurse" className="text-dark font-weight-bold">Nurse</label>
                      ...
                      <div class="form-group">
                        <label for="phone" className="text-dark font-weight-bold">Phone</label>
